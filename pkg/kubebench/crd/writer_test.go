...
import (
	...
	starboardClientset "github.com/khulnasoft/starboard/pkg/generated/clientset/versioned"
	starboardClientsetFake "github.com/khulnasoft/starboard/pkg/generated/clientset/versioned/fake"
	"github.com/khulnasoft/starboard/pkg/kube"
	"github.com/khulnasoft/starboard/pkg/kubebench/crd"
	...
	Describe("Writing report", func() {
		...
		Context("when report does not exist", func() {
			...
			It("should create a report", func() {
				...
				report, err := clientset.KhulnasoftV1alpha1().CISKubeBenchReports().
		...
		Context("when report already exists", func() {
			...
			It("should update a report", func() {
				...
				reportList, err := clientset.KhulnasoftV1alpha1().CISKubeBenchReports().
	...
	Describe("Reading report", func() {
		...
		Context("when report does not exist", func() {
			...
			It("should return error not found", func() {
				...
				Expect(err.Error()).To(Equal("ciskubebenchreports.khulnasoft.github.io \"worker-node\" not found"))
			})
