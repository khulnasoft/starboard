...
import (
	...
	"github.com/khulnasoft/starboard/pkg/docker"
...
var _ = Describe("Docker", func() {
	...
	DescribeTable("GetHostFromServer", func(server, expectedHost string) {
		...
		Entry("registry.khulnasoft.com",
			"registry.khulnasoft.com", "registry.khulnasoft.com"),
	...
	DescribeTable("GetServerFromImageRef", func(imageRef, expectedServer string) {
		...
		Entry("khulnasoft/trivy:0.10.0",
			"khulnasoft/trivy:0.10.0", "index.docker.io"),
		Entry("docker.io/khulnasoft/harbor-scanner-trivy:0.10.0",
			"docker.io/khulnasoft/harbor-scanner-trivy:0.10.0", "index.docker.io"),
		Entry("index.docker.io/khulnasoft/harbor-scanner-trivy:0.10.0",
			"index.docker.io/khulnasoft/harbor-scanner-trivy:0.10.0", "index.docker.io"),
