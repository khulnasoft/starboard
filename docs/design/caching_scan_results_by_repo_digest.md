...
My suggestion is to solve this problem just like we did in [PR #879](https://github.com/khulnasoft/starboard/pull/879).
For each ClusterVulnerabilityReport created we should annotate the report with `starboard.khulnasoft.github.io/cluster-vulnerability-report-ttl`.
...
For example: `starboard.khulnasoft.github.io/ClusterVulnerabilityReportName: 84bcb5cd46` would make it easy to find.
...
[Standalone]: https://khulnasoft.github.io/starboard/v0.12.0/integrations/vulnerability-scanners/trivy/#standalone
[ClientServer]: https://khulnasoft.github.io/starboard/v0.12.0/integrations/vulnerability-scanners/trivy/#clientserver
[PR #879]: (https://github.com/khulnasoft/starboard/pull/879)
