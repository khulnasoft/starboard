...
import (
	. "github.com/khulnasoft/starboard/itest/matcher"
	...
	"github.com/khulnasoft/starboard/itest/helper"
	...
	Describe("Command install", func() {
		...
		It("should install Starboard", func() {
			...
			Expect(crdList.Items).To(MatchAllElements(groupByName, Elements{
				...
				"clustervulnerabilityreports.khulnasoft.github.io": MatchFields(IgnoreExtras, Fields{
					"Spec": MatchFields(IgnoreExtras, Fields{
						"Group":   Equal("khulnasoft.github.io"),
						"Version": Equal("v1alpha1"),
						"Names": Equal(apiextensionsv1beta1.CustomResourceDefinitionNames{
				...
				"clustercompliancereports.khulnasoft.github.io": MatchFields(IgnoreExtras, Fields{
					"Spec": MatchFields(IgnoreExtras, Fields{
						"Group":   Equal("khulnasoft.github.io"),
						"Version": Equal("v1alpha1"),
						"Names": Equal(apiextensionsv1beta1.CustomResourceDefinitionNames{
				...
				"clustercompliancedetailreports.khulnasoft.github.io": MatchFields(IgnoreExtras, Fields{
					"Spec": MatchFields(IgnoreExtras, Fields{
						"Group":   Equal("khulnasoft.github.io"),
						"Version": Equal("v1alpha1"),
						"Names": Equal(apiextensionsv1beta1.CustomResourceDefinitionNames{
				...
				"clusterconfigauditreports.khulnasoft.github.io": MatchFields(IgnoreExtras, Fields{
					"Spec": MatchFields(IgnoreExtras, Fields{
						"Group":   Equal("khulnasoft.github.io"),
						"Version": Equal("v1alpha1"),
						"Scope":   Equal(apiextensionsv1beta1.ClusterScoped),
