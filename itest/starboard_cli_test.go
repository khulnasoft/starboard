...
var _ = Describe("Starboard CLI", func() {
	...
	Describe("Command init", func() {
		...
		It("should initialize Starboard", func() {
			...
			Expect(crdList.Items).To(MatchAllElements(id, Elements{
				"vulnerabilityreports.khulnasoft.github.io": MatchFields(IgnoreExtras, Fields{
					"Spec": MatchFields(IgnoreExtras, Fields{
						"Group":   Equal("khulnasoft.github.io"),
				...
				"configauditreports.khulnasoft.github.io": MatchFields(IgnoreExtras, Fields{
					"Spec": MatchFields(IgnoreExtras, Fields{
						"Group":   Equal("khulnasoft.github.io"),
						"Version": Equal("v1alpha1"),
						"Scope":   Equal(apiextensionsv1beta1.NamespaceScoped),
				...
				"ciskubebenchreports.khulnasoft.github.io": MatchFields(IgnoreExtras, Fields{
					"Spec": MatchFields(IgnoreExtras, Fields{
						"Group":   Equal("khulnasoft.github.io"),
						"Version": Equal("v1alpha1"),
				...
				"kubehunterreports.khulnasoft.github.io": MatchFields(IgnoreExtras, Fields{
					"Spec": MatchFields(IgnoreExtras, Fields{
						"Group":   Equal("khulnasoft.github.io"),
						"Version": Equal("v1alpha1"),
						"Scope":   Equal(apiextensionsv1beta1.ClusterScoped),
	...
	Describe("Command find vulnerabilities", func() {
		...
		Context("when unmanaged Pod is specified as workload", func() {
			...
			It("should create vulnerabilities resource", func() {
				...
				reportList, err := starboardClientset.KhulnasoftV1alpha1().VulnerabilityReports(podNamespace).
		...
		Context("when ReplicaSet is specified as workload", func() {
			...
			It("should create vulnerabilities resource", func() {
				...
				reportList, err := starboardClientset.KhulnasoftV1alpha1().VulnerabilityReports(rsNamespace).
					List(context.TODO(), metav1.ListOptions{
						LabelSelector: labels.Set{
		...
		Context("when ReplicationController is specified as workload", func() {
			...
			It("should create vulnerabilities resource", func() {
				...
				reportList, err := starboardClientset.KhulnasoftV1alpha1().VulnerabilityReports(rcNamespace).
					List(context.TODO(), metav1.ListOptions{
						LabelSelector: labels.Set{
		...
		Context("when Deployment is specified as workload", func() {
			...
			It("should create vulnerabilities resource", func() {
				...
				reportList, err := starboardClientset.KhulnasoftV1alpha1().VulnerabilityReports(deployNamespace).
					List(context.TODO(), metav1.ListOptions{
						LabelSelector: labels.Set{
	...
	Describe("Command polaris", func() {
		...
		Context("when unmanaged Pod is specified as workload", func() {
			...
			It("should create configaudit resource", func() {
				...
				reportList, err := starboardClientset.KhulnasoftV1alpha1().ConfigAuditReports(podNamespace).
					List(context.TODO(), metav1.ListOptions{
						LabelSelector: labels.Set{
							kube.LabelResourceKind:      "Pod",
							kube.LabelResourceName:      podName,
	...
	Describe("Command run kube-bench", func() {
		...
		It("should run kube-bench", func() {
			...
			for _, node := range nodeList.Items {
				report, err := starboardClientset.KhulnasoftV1alpha1().CISKubeBenchReports().
	...
	PDescribe("Command run kube-hunter", func() {
		...
		It("should run kube-hunter", func() {
			...
			report, err := starboardClientset.KhulnasoftV1alpha1().KubeHunterReports().
